...
public class Mechanics {
    ...
    public static boolean attack(Player attacker, Item weapon, Player defender, Item defendWeapon, Tile defendTile) {
        if (Math.random() * 100 < accuracy(attacker, weapon, defender, defendWeapon, Item.isBetter(weapon, defendWeapon))) {
            defender.stats.hp -= critChance(attacker, weapon, defender) > Math.random() * 100 
                    ? critDamage(attacker, weapon, defender, Item.isBetter(weapon, defendWeapon)) 
                    : damage(attacker, weapon, defender, defendTile, Item.isBetter(weapon, defendWeapon));
